...
export class ProductService {
  ...
  private productSelectedSuject = new BehaviorSubject<number>(0);
  productSelectedAction$ = this.productSelectedSuject.asObservable();
  ...
  // selectedproductSuppiers$ = combineLatest([
  ...
  selectedProductChanged(selectedProductId: number): void {
    this.productSelectedSuject.next(selectedProductId);
  }
